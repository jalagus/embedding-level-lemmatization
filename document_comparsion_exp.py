...
model_date = "2020-12-18_22-15-52"
scoring = "mse"
model_type = "simple"
all_res_vecs = []

exp_word_cases = ['genative', 'inessive', 'elative', 'partitive']
...
for run_id in range(10):
    ...
    for reg_param in [p / 10.0 for p in range(1, 11)]:
        ...
        lemma_model_chains.append(('none', [lambda x: x]))
    ...
    res_df.to_csv(f"doc_comparison_results_{scoring}_{word_case}_{model_type}.csv")